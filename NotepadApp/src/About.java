...
public class About extends JFrame {
		...
		About()
		{
			...
			ImageIcon icon = new ImageIcon(getClass().getResource("Notepad_Icon_72.png"));
			setIconImage(icon.getImage());
			
			setLayout(null);
			
			JLabel iconLabel=new JLabel(new ImageIcon(getClass().getResource("Notepad_Icon_72.png")));
